...
{
    public partial class Form_1NhaSach : Form
    {
        ...
        public Form_1NhaSach()
        {
            InitializeComponent();
        }

        public Form_1NhaSach(string title)
        {
        ...
        public Form_1NhaSach(string title, DataGridViewRow currentRow)
        {
            InitializeComponent();
