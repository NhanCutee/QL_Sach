...
{
    public partial class Form_1NhanVien : Form
    {
        ...
        public Form_1NhanVien()
        {
            InitializeComponent();
        }

        public Form_1NhanVien(string title)
        {
        ...
        public Form_1NhanVien(string title, DataGridViewRow currentRow)
        {
            InitializeComponent();
